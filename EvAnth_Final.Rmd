...
probability_kid1 <- prop_fh + prop_fn
probability_kid1
```

```{r}
#probability of child being feebleminded given that both parents are feebleminded

probability_kid2 <- prop_ff
probability_kid2
...
probability_parent <- (prop_fh + prop_fn) / (prop_ff + prop_hh + prop_nh + prop_nn + prop_fh + prop_fn)
probability_parent
```
