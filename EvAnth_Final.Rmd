...
```{r}
for (i in 1:10){
  genokid <- c(genokid, parent1[i] + parent2[i])
  if(genokid[i] > 2)
    genokid[i] <- 2
...
for (i in 1:numind){
  pheno_feeble_feeble$phenos[i] <- genokid %*% eff
=======
<<<<<<< HEAD
}
for (i in 1:numind){
...
>>>>>>> deab5cfa11ef442e156083e70a05572bc99f38f1
>>>>>>> fc30699706a4687281509b4da1bb5081397f7240
}
parent1
parent2
genokid
