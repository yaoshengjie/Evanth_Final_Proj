...
```{r}
genokid_feeble_feeble <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
genokid_feeble_normal <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
genokid_feeble_high <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
genokid_normal_normal <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
genokid_normal_high <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
genokid_high_high <- matrix(rep(NA, numind * 10), nrow = 1000, ncol = 10)
```
